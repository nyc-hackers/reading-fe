...
(function() {
  var destination, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, parse, path, showdown, spawn, template, _ref;
  ...
  generate_html = function(source, sections, sources) {
    var dest, html, title;
